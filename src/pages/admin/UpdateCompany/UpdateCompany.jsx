      ...
      <div className="form-container">
        ...
        <div>
          ...
          >
            ...
            <input type="text" placeholder={company?.companyName} />
            <br />
            Descripcion de la empressa:
            <br />
            <InputTextarea
              className="descriocion-empressa"
              autoResize
              value={desc}
